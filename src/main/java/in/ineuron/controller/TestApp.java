...
public class TestApp {
	...
	private static void updateRecord() throws IOException {
		...
		if (student != null) {
			...
			System.out.print("Student oldAddress is :: " + student.getScity() + "  Enter newAddress :: ");
			String newAddress = br.readLine();
			if (newAddress.equals("") || newAddress == "") {
				newStudent.setScity(student.getScity());
			} else {
				newStudent.setScity(newAddress);
			}
	...
	private static void selectOperation() {
		...
		if (std != null) {
			...
			System.out.println(std.getSid() + "\t" + std.getSname() + "\t" + std.getSage() + "\t" + std.getScity());
		} else {
